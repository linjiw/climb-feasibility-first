...
COMMIT='140d225205cee9d401fcaf7b1a54f8f8265b4165'
...
for attempt in range(6):
    ...
    time.sleep(7)
files=['index.html','relative-progress.html','assets/research-story.js']
files += [str(p.relative_to(ROOT/'docs')) for p in (ROOT/'docs/assets/confirmation-2026-09-06').iterdir() if p.is_file()]
def check(name):
...
(ROOT/'reports/confirmation_pages_2026-09-06/deployment_verification.json').write_text(json.dumps(result,indent=2)+'\n')
