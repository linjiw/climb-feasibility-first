...
def verify_contract(path: Path, digest: str, *, smoke: bool = False) -> dict:
    ...
    if verified(contract["evaluator_adapter"], "evaluator adapter") != ROOT / "tools/eval_relative_confirmation.py":
        raise ValueError("contract binds another evaluator adapter")
