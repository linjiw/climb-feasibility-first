...
def verify_study(study: Path, seed: int) -> dict:
    ...
    for stage in ("smoke", "long"):
        ...
        # Reproduce the original path spelling as well as every measured value.
        # Older smoke summaries retain relative ledger keys; resolving them here
        # changes the result dictionary despite identical files and hashes.
