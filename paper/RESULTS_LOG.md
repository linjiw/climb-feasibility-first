...
| repair operator validation row (see 2026-08-20 entry); census 2×2 matrix | companion §8, payoff plan | `reports/repair_census/summary.{json,md}` (pending 🕐 aggregation) | pending 🕐 |
