...
| **Phase G sealed; seed-1 G1/G2 authorized** | Linji explicitly approved the seal and seed-1 launch on 2026-09-05. The 41-file seal verifies with manifest SHA-256 `0a51b4803a51d9b6eb1fb51f8be77638ea2cc70ba5700dbdbc79ac0dfca94a55`. Endpoint-blind calibration selected `rho = 0.40`, `lambda = 0.05`; the independent seed passed (mean TV 0.1056, minimum 700.1 effective units, maximum top-1 0.0134, zero invalid/censored events). Seed 1 is authorized for matched 4,000-iteration, 512-environment G1/G2 runs. Policy endpoints remain closed until the seed-1 ledger-only manipulation gate passes; seeds 2–3 are not yet authorized. | `plan/G_SEGMENT_FREEZE.sha256`, `plan/G_SEGMENT_APPROVAL_2026-09-05.md`, `plan/PREREGISTRATION_G_SEGMENT.md`, `tools/run_g_segment_seed1.sh` |
